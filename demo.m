...
base_path  = 'D:/DataSet/OTB2015/OTB100'; % (or OTB / VOT root path)

video = choose_video(base_path);
video_path = 'D:/DataSet/OTB2015/OTB100/MotorRolling/';
video_path = [base_path '/' video];
[seq, gt_boxes] = load_video(video_path,video);

% Run tracker
results = run_GFSDCF_1(seq);
% results = VOT2018setting(seq);
